...
public class MainActivity extends AppCompatActivity {
    ...
    final String APP_ID = "64c43ebaa3e06eeb419251aab7bf29be";
...
//    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode==REQUEST_CODE)
        {
            ...
            {
                Toast.makeText(MainActivity.this, "Location Successfully", Toast.LENGTH_SHORT).show();
                getWeatherForCurrentLocation();
            }
        }
        else
        {
            //when user denid the location
    ...
    {
        Temprature.setText(weatherD.getmTemprature());
